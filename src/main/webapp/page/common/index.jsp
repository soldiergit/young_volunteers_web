...
<head>
    ...
    <link rel="icon" href="/young_volunteers_web_war/images/favicon.ico">
    <link rel="stylesheet" href="/young_volunteers_web_war/layui/css/layui.css" media="all" />
    <link rel="stylesheet" href="/young_volunteers_web_war/css/index.css" media="all" />
</head>
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="/young_volunteers_web_war/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">admin</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="/young_volunteers_web_war/page/user/userInfo.html"><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:;" data-url="/young_volunteers_web_war/page/user/changePwd.html"><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="/young_volunteers_web_war/login_view.action?view=main"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="/young_volunteers_web_war/page/common/main.jsp"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="/young_volunteers_web_war/js/index.js"></script>
<script type="text/javascript" src="/young_volunteers_web_war/js/cache.js"></script>
</body>
</html>
